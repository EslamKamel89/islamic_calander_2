...
import 'package:islamic_calander_2/features/tasks/presentation/add_task_view.dart';
import 'package:islamic_calander_2/features/tasks/presentation/task_view.dart';
...
class AppRouter {
  ...
  Route? onGenerateRoute(RouteSettings routeSettings) {
    ...
    switch (routeName) {
      ...
      case AppRoutesNames.tasksView:
        return CustomPageRoute(
          builder: (context) => const TasksView(),
          settings: routeSettings,
        );
      case AppRoutesNames.addTaskView:
        return CustomPageRoute(
