...
import 'package:islamic_calander_2/core/extensions/datatime_extension.dart';
...
class PrayerTimeParams {
  ...
  PrayerTimeParams(
      {this.latitude, this.longitude, this.method, this.latitudeAdjustmentMethod, this.date});
  ...
  String toKey(DateTime date) {
    final d = date.toShortDateString();
    return '$latitude/$longitude/$method/$latitudeAdjustmentMethod/$d';
  }
...
enum IslamicOrganization {
  ...
  majlisUgamaIslamSingapura(
      11, 'Majlis Ugama Islam Singapura, Singapore', "مجلس العلماء المسلمين، سنغافورة"),
  ...
  jabatanKemajuanIslamMalaysia(
      17, 'Jabatan Kemajuan Islam Malaysia (JAKIM)', "إدارة التنمية الإسلامية الماليزية"),
